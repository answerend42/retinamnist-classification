...
class RetinaMNISTLitModule(LightningModule):
    """LightningModule for Retina MNIST classification.
    ...
    def __init__(
        ...
        """Initialize a `RetinaMNISTLitModule`.

        :param net: The model to train.
        :param optimizer: The optimizer to use for training.
        :param scheduler: The learning rate scheduler to use for training.
        :param compile: Whether to compile the model for faster training.
        ...
        # metric objects for calculating AUC (Area Under ROC Curve)
...
if __name__ == "__main__":
    _ = RetinaMNISTLitModule(None, None, None, None)